...
public class DaoZaiInventoryWrapper implements IInventory
{
    final IDaoZaiItemHandler handler;
    final EntityPlayer player;

    public DaoZaiInventoryWrapper(IDaoZaiItemHandler handler) { super(); this.handler = handler; this.player = null; }
    public DaoZaiInventoryWrapper(IDaoZaiItemHandler handler, EntityPlayer player) { super(); this.handler = handler; this.player = player; }

    @Override public String getName() { return "DaoZaiInventory"; }
