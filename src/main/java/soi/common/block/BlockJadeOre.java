...
import static soi.common.item.ordinary.ItemJade.JADE;

public class BlockJadeOre extends Block
{
    public static final Block BLOCK_JADE_ORE = new BlockJadeOre();
    public static final ItemBlock JADE_ORE = new ItemBlock(BLOCK_JADE_ORE);
