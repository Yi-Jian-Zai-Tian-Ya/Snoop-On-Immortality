    ...
    public static class Handler implements IMessageHandler<MessageTransferToStorageBag, IMessage>
    {
        ...
        public IMessage onMessage(MessageTransferToStorageBag msg, MessageContext ctx)
        {
            ...
            player.getServerWorld().addScheduledTask(() -> {
                ...
                IDaoZaiItemHandler handler = DaoZaiAPI.getDaoZaiHandler(player);
                ItemStack bag = handler.getStackInSlot(msg.index);
                ...
                IItemHandler inv = info.getInventory();
                ...
                for (int i = 0; i < chestSize; i++)
                {
                    ...
                    ItemStack remaining = ItemHandlerHelper.insertItem(inv, stack.copy(), false);
                ...
                if (changed) { ((IStorageBag) bag.getItem()).updateStorageBag(bag, info); handler.setChanged(msg.index, true); }
